...
export default function ListContainer() {
  ...
  return (
    <div className="rounded-md border-4 border-black bg-colors-customYellow m-3 p-4 sm:w-[calc(100%-17px)] md:w-1/2 lg:w-1/3 h-[70vh] sm:h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-y-auto">
